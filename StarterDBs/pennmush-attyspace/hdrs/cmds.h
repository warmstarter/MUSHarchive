...
COMMAND_PROTO(cmd_rob);
COMMAND_PROTO(cmd_rpage);
COMMAND_PROTO(cmd_rules);
COMMAND_PROTO(cmd_rwall);
COMMAND_PROTO(cmd_rwallemit);
COMMAND_PROTO(cmd_rwallpose);
...
COMMAND_PROTO(cmd_wallemit);
COMMAND_PROTO(cmd_wallpose);
...
COMMAND_PROTO(cmd_wizemit);
COMMAND_PROTO(cmd_wizmotd);
COMMAND_PROTO(cmd_wizpose);
