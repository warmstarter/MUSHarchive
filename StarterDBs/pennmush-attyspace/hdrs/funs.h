...
FUNCTION_PROTO(fun_cash);
FUNCTION_PROTO(fun_cat);
FUNCTION_PROTO(fun_cdb);
...
FUNCTION_PROTO(fun_dbeval);
FUNCTION_PROTO(fun_dbget);
FUNCTION_PROTO(fun_dbhasattr);
FUNCTION_PROTO(fun_dblattr);
FUNCTION_PROTO(fun_dbquota);
FUNCTION_PROTO(fun_dbset);
FUNCTION_PROTO(fun_dbufun);
FUNCTION_PROTO(fun_dbusage);
FUNCTION_PROTO(fun_dbv);
FUNCTION_PROTO(fun_dec);
FUNCTION_PROTO(fun_decrypt);
FUNCTION_PROTO(fun_default);
FUNCTION_PROTO(fun_deg2rad);
...
FUNCTION_PROTO(fun_ifelse);
FUNCTION_PROTO(fun_ifthen);
FUNCTION_PROTO(fun_inc);
FUNCTION_PROTO(fun_index);
FUNCTION_PROTO(fun_insert);
FUNCTION_PROTO(fun_inv);
FUNCTION_PROTO(fun_inzone);
FUNCTION_PROTO(fun_isa);
...
FUNCTION_PROTO(fun_ly2pc);
FUNCTION_PROTO(fun_ly2su);
FUNCTION_PROTO(fun_lzone);
FUNCTION_PROTO(fun_mag);
...
FUNCTION_PROTO(fun_org);
FUNCTION_PROTO(fun_orgnum);
FUNCTION_PROTO(fun_owner);
FUNCTION_PROTO(fun_parent);
FUNCTION_PROTO(fun_pc2ly);
FUNCTION_PROTO(fun_pc2su);
...
FUNCTION_PROTO(fun_race);
FUNCTION_PROTO(fun_racename);
FUNCTION_PROTO(fun_rad2deg);
FUNCTION_PROTO(fun_rand);
FUNCTION_PROTO(fun_rank);
FUNCTION_PROTO(fun_rankname);
...
FUNCTION_PROTO(fun_sd2secs);
FUNCTION_PROTO(fun_sdb);
FUNCTION_PROTO(fun_secs);
FUNCTION_PROTO(fun_secs2sd);
...
FUNCTION_PROTO(fun_spacenum);
FUNCTION_PROTO(fun_sph2xyz);
...
FUNCTION_PROTO(fun_su2ly);
FUNCTION_PROTO(fun_su2pc);
FUNCTION_PROTO(fun_sub);
FUNCTION_PROTO(fun_subj);
FUNCTION_PROTO(fun_sum);
