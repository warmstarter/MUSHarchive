 ...
 */
extern dbref match_result _((const dbref who, const char *name, const int type, const long int flags));
extern dbref noisy_match_result _((const dbref who, const char *name, const int type, const long int flags));
extern dbref last_match_result _((const dbref who, const char *name, const int type, const long int flags));
