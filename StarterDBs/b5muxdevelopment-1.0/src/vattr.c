 ...
 */
/*
 * $Id: vattr.c,v 1.1 2001/01/15 03:14:11 wenk Exp $ 
 */
...
#ifdef GATHER_STATS
	sprintf(buff, "Vattr stats:  %d alloc, %d free, %d name lookups, %d page faults in lookups.\n",
		vstats_count, vstats_freecnt, vstats_lookups, page_faults);
#else
	sprintf(buff, "Vattr stats:  %d alloc, %d free, %d name lookups\n",
		vstats_count, vstats_freecnt, vstats_lookups);
#endif
