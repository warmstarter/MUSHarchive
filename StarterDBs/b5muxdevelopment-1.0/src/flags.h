...
/* $Id: flags.h,v 1.1 2001/01/15 03:22:20 wenk Exp $ */
...
#define ITEM 		 0x00000002
#define REGISTERED	 0x00000004
#define IC		 0x00000008
#define PREREG		 0x00000010
#define RELAY 		 0x00000020
#define MOB	  	 0x00000040
#define UNCON	  	 0x00000080
#define ASLEEP	  	 0x00000100
#define DEAD	  	 0x00000200
#define ORG	  	 0x00000400
#define FOOD	  	 0x00000800


/*back to 2nd word*/
#define WEAPON		0x00040000
#define VEHICLE		0x00080000
#define ARMOR		0x00100000
#define CONSOLE		0x00200000
#define SHIPIN		0x00400000   /*This means dockign bay if set on room*/
#define SHIPEXIT	0x00800000
