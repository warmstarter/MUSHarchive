/* db.h */
/* $Id: db.h,v 1.1 2001/01/15 03:22:20 wenk Exp $ */
...
#define StackSize(t)		db[t].stackcount
...
#define s_StackSize(t,n)	db[t].stackcount = (n)
