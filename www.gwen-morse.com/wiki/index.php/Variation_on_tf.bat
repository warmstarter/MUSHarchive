...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" dir="ltr">
	<head>
		...
		<meta name="keywords" content="Variation on tf.bat" />
		...
		<title>Variation on tf.bat - GwenWiki</title>
		...
		var wgPageName = "Variation_on_tf.bat";
		var wgTitle = "Variation on tf.bat";
		var wgAction = "view";
		var wgArticleId = "175";
...
<body class="mediawiki ltr ns-0 ns-subject page-Variation_on_tf_bat skin-monobook">
	<div id="globalWrapper">
		<div id="column-content">
	<div id="content">
		<a name="top" id="top"></a>
				<h1 id="firstHeading" class="firstHeading">Variation on tf.bat</h1>
		<div id="bodyContent">
			<h3 id="siteSub">From GwenWiki</h3>
			<div id="contentSub"></div>
									<div id="jump-to-nav">Jump to: <a href="#column-one">navigation</a>, <a href="#searchInput">search</a></div>			<!-- start content -->
			<p>To have rxvt working, I put a copy of rxvt.exe in the main Tinyfugue directory. I keep a copy of each cygwin .dll and .exe file I 'need' for Tinyfugue, in the main Tinyfugue directory itself. This should not cause any cygwin conflicts, as long as you don't have different versions of cygwin1.dll on your system.
</p><p>To get things copied over correctly, open a regular windows cmd shell. Paste a copy of rxvt.exe from the cygwin install into your main tinyfugue directory. Type "rxvt.exe" in the Windows cmd shell. It will probably give you an error that some .dll is missing. Copy this over to the Tinyfugue directory from the cygwin install. Repeat until rxvt opens.
</p><p>Once rxvt is working, from the Windows cmd shell type "tf.exe". Copy missing exe files and/or .dll files from the cygwin install until Tinyfugue opens.
</p><p>Once both open via the Windows cmd shell, edit this script to point to the Tinyfugue directory on your local system, drop a copy in that directory, and run the .bat file. You should have Tinyfugue running in rxvt at this point.
</p>
<pre>
@echo off
E:
...
<!-- Saved in parser cache with key homesitewiki-mw_:pcache:idhash:175-0!1!0!!en!2!edit=0 and timestamp 20120421155807 -->
<div class="printfooter">
Retrieved from "<a href="http://www.gwen-morse.com/wiki/index.php/Variation_on_tf.bat">http://www.gwen-morse.com/wiki/index.php/Variation_on_tf.bat</a>"</div>
						<!-- end content -->
	...
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				 ...
				 <li id="ca-nstab-main" class="selected"><a href="/wiki/index.php/Variation_on_tf.bat" title="View the content page [c]" accesskey="c">Page</a></li>
				 <li id="ca-talk" class="new"><a href="/wiki/index.php?title=Talk:Variation_on_tf.bat&amp;action=edit&amp;redlink=1" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				 <li id="ca-viewsource"><a href="/wiki/index.php?title=Variation_on_tf.bat&amp;action=edit" title="This page is protected.&#10;You can view its source [e]" accesskey="e">View source</a></li>
				 <li id="ca-history"><a href="/wiki/index.php?title=Variation_on_tf.bat&amp;action=history" title="Past revisions of this page [h]" accesskey="h">History</a></li>			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/wiki/index.php?title=Special:UserLogin&amp;returnto=Variation_on_tf.bat" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="portlet" id="p-tb">
		...
		<div class="pBody">
			<ul>
				<li id="t-whatlinkshere"><a href="/wiki/index.php/Special:WhatLinksHere/Variation_on_tf.bat" title="List of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
				<li id="t-recentchangeslinked"><a href="/wiki/index.php/Special:RecentChangesLinked/Variation_on_tf.bat" title="Recent changes in pages linked from this page [k]" accesskey="k">Related changes</a></li>
<li id="t-specialpages"><a href="/wiki/index.php/Special:SpecialPages" title="List of all special pages [q]" accesskey="q">Special pages</a></li>
				<li id="t-print"><a href="/wiki/index.php?title=Variation_on_tf.bat&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>				<li id="t-permalink"><a href="/wiki/index.php?title=Variation_on_tf.bat&amp;oldid=973" title="Permanent link to this revision of the page">Permanent link</a></li>			</ul>
		</div>
	</div>
			...
			<ul id="f-list">
					<li id="lastmod"> This page was last modified on 12 September 2011, at 15:32.</li>
