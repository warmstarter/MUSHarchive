...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" dir="ltr">
	<head>
		...
		<meta name="keywords" content="Simple tf.bat" />
		...
		<title>Simple tf.bat - GwenWiki</title>
		...
		var wgPageName = "Simple_tf.bat";
		var wgTitle = "Simple tf.bat";
		var wgAction = "view";
		var wgArticleId = "174";
...
<body class="mediawiki ltr ns-0 ns-subject page-Simple_tf_bat skin-monobook">
	<div id="globalWrapper">
		<div id="column-content">
	<div id="content">
		<a name="top" id="top"></a>
				<h1 id="firstHeading" class="firstHeading">Simple tf.bat</h1>
		<div id="bodyContent">
...
<!-- Saved in parser cache with key homesitewiki-mw_:pcache:idhash:174-0!1!0!!en!2!edit=0 and timestamp 20120421154951 -->
<div class="printfooter">
Retrieved from "<a href="http://www.gwen-morse.com/wiki/index.php/Simple_tf.bat">http://www.gwen-morse.com/wiki/index.php/Simple_tf.bat</a>"</div>
						<!-- end content -->
	...
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				 ...
				 <li id="ca-nstab-main" class="selected"><a href="/wiki/index.php/Simple_tf.bat" title="View the content page [c]" accesskey="c">Page</a></li>
				 <li id="ca-talk" class="new"><a href="/wiki/index.php?title=Talk:Simple_tf.bat&amp;action=edit&amp;redlink=1" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				 <li id="ca-viewsource"><a href="/wiki/index.php?title=Simple_tf.bat&amp;action=edit" title="This page is protected.&#10;You can view its source [e]" accesskey="e">View source</a></li>
				 <li id="ca-history"><a href="/wiki/index.php?title=Simple_tf.bat&amp;action=history" title="Past revisions of this page [h]" accesskey="h">History</a></li>			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/wiki/index.php?title=Special:UserLogin&amp;returnto=Simple_tf.bat" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="portlet" id="p-tb">
		...
		<div class="pBody">
			<ul>
				<li id="t-whatlinkshere"><a href="/wiki/index.php/Special:WhatLinksHere/Simple_tf.bat" title="List of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
				<li id="t-recentchangeslinked"><a href="/wiki/index.php/Special:RecentChangesLinked/Simple_tf.bat" title="Recent changes in pages linked from this page [k]" accesskey="k">Related changes</a></li>
<li id="t-specialpages"><a href="/wiki/index.php/Special:SpecialPages" title="List of all special pages [q]" accesskey="q">Special pages</a></li>
				<li id="t-print"><a href="/wiki/index.php?title=Simple_tf.bat&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>				<li id="t-permalink"><a href="/wiki/index.php?title=Simple_tf.bat&amp;oldid=839" title="Permanent link to this revision of the page">Permanent link</a></li>			</ul>
		</div>
	</div>
			...
			<ul id="f-list">
					<li id="lastmod"> This page was last modified on 7 September 2011, at 14:06.</li>
