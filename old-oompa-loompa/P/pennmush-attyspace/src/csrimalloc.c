...
/* $Id: csrimalloc.c,v 1.38 1998/02/19 19:27:05 dunemush Exp dunemush $ */
#ifndef __ASSERT_H__
#define __ASSERT_H__
#ifdef CSRI_DEBUG
#define ASSERT(p, s) \
...
const char *_malloc_version = "CSRI, University of Toronto Malloc Version 1.18alpha";
 ...
 */
    ...
    extern const Size_t _malloc_binmax[];
...
/* Tracing malloc definitions - helps find leaks */
    univptr_t __malloc _((Size_t nbytes, const char *fname, int linenum));
    univptr_t __calloc _((Size_t nelem, Size_t elsize, const char *fname, int linenum));
    univptr_t __realloc _((univptr_t cp, Size_t nbytes, const char *fname, int linenum));
    univptr_t __valloc _((Size_t size, const char *fname, int linenum));
    univptr_t __memalign _((Size_t alignment, Size_t size, const char *fname, int linenum));
    univptr_t __emalloc _((Size_t nbytes, const char *fname, int linenum));
    univptr_t __ecalloc _((Size_t nelem, Size_t sz, const char *fname, int linenum));
    univptr_t __erealloc _((univptr_t ptr, Size_t nbytes, const char *fname, int linenum));
    char *__strdup _((const char *s, const char *fname, int linenum));
    char *__strsave _((const char *s, const char *fname, int linenum));
    void __free _((univptr_t cp, const char *fname, int linenum));
    void __cfree _((univptr_t cp, const char *fname, int linenum));
#else				/* CSRI_TRACE */
    univptr_t malloc _((Size_t nbytes));
    univptr_t calloc _((Size_t nelem, Size_t elsize));
    univptr_t realloc _((univptr_t cp, Size_t nbytes));
    univptr_t valloc _((Size_t size));
    univptr_t memalign _((Size_t alignment, Size_t size));
    univptr_t emalloc _((Size_t nbytes));
    univptr_t ecalloc _((Size_t nelem, Size_t sz));
    univptr_t erealloc _((univptr_t ptr, Size_t nbytes));
    Free_t free _((univptr_t cp));
    Free_t cfree _((univptr_t cp));
#endif				/* CSRI_TRACE */
   
    int __m_botch _((const char *s1, const char *s2, univptr_t p,
		     int is_end_ptr, const char *filename, int linenumber));
    void __m_prnode _((SPBLK *spblk));
    void mal_contents _((FILE *fp));
    void mal_debug _((int level));
    void mal_dumpleaktrace _((FILE * fp));
    void mal_heapdump _((FILE * fp));
    void mal_leaktrace _((int value));
    void mal_sbrkset _((int n));
    void mal_slopset _((int n));
    void mal_statsdump _((FILE * fp));
    void mal_trace _((int value));
    int mal_verify _((int fullcheck));
    void mal_mmap _((char *fname));
