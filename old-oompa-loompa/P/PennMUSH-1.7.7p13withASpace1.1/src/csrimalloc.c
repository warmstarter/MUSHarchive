...
/* $Id: csrimalloc.c 1.23.1.4 Sun, 01 Dec 2002 21:14:41 -0600 dunemush $ */
#ifndef __ASSERT_H__
#define __ASSERT_H__
#ifdef CSRI_DEBUG
#define ASSERT(p, s) \
...
univptr_t
__malloc _((size_t nbytes, const char *fname, int linenum));
univptr_t
__calloc _((size_t nelem, size_t elsize, const char *fname, int linenum));
univptr_t
__realloc _((univptr_t cp, size_t nbytes, const char *fname, int linenum));
univptr_t __valloc _((size_t size, const char *fname, int linenum));
univptr_t
__memalign _((size_t alignment, size_t size, const char *fname, int linenum));
univptr_t __emalloc _((size_t nbytes, const char *fname, int linenum));
univptr_t
__ecalloc _((size_t nelem, size_t sz, const char *fname, int linenum));
univptr_t
__erealloc _((univptr_t ptr, size_t nbytes, const char *fname, int linenum));
char *__strdup _((const char *s, const char *fname, int linenum));
char *__strsave _((const char *s, const char *fname, int linenum));
void
__free _((univptr_t cp, const char *fname, int linenum));
void
__cfree _((univptr_t cp, const char *fname, int linenum));
#else				/* CSRI_TRACE */
univptr_t
